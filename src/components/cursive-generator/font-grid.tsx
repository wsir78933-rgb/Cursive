...
export const FontGrid = memo(function FontGrid({
  ...
  return (
    <section
      aria-label="Cursive font styles"
      className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-3 px-4 pb-12 sm:grid-cols-2 md:px-8 lg:grid-cols-3 xl:grid-cols-5"
    >
